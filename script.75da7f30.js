...
},{}],"util/addGlobalEventListner.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = addGlobalEventListner;
...
var _addGlobalEventListner = _interopRequireDefault(require("./util/addGlobalEventListner.js"));
...
var cartWrapper = document.querySelector('[data-cart-items-wrapper]');
...
function setUpShoppingCart() {
  (0, _addGlobalEventListner.default)('click', '[data-remove-from-cart-button]', function (e) {
...
function loadCart() {
  var c = sessionStorage.getItem(SESSION_STORAGE_KEY);
  return JSON.parse(c) || [];
}
function hideCart() {
...
function renderCartItems() {
  ...
  cartTotal.innerHTML = (0, _formatCurrency.default)(totalCents / 100);
...
},{"./items.json":"items.json","./util/addGlobalEventListner.js":"util/addGlobalEventListner.js","./util/formatCurrency.js":"util/formatCurrency.js"}],"store.js":[function(require,module,exports) {
"use strict";
...
function setUpStore() {
  ...
  (0, _addGlobalEventListner.default)('click', '[data-add-to-cart-button]', function (e) {
...
},{"./items.json":"items.json","./shoppingCart.js":"shoppingCart.js","./util/formatCurrency.js":"util/formatCurrency.js","./util/addGlobalEventListner.js":"util/addGlobalEventListner.js"}],"script.js":[function(require,module,exports) {
"use strict";

var _store = require("./store.js");
var _shoppingCart = _interopRequireDefault(require("./shoppingCart.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
console.log("hi");
(0, _store.setUpStore)();
